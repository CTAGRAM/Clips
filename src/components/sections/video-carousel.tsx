...
const VideoCarousel = () => {
  ...
  return (
    <>
      ...
      <section className="relative w-full overflow-hidden select-none -mt-24 md:-mt-[120px] pb-20 md:pb-32">
        <div className="group">
          <div className="flex w-max animate-scroll-left group-hover:[animation-play-state:paused]">
            {duplicatedVideos.map((video, index) => (
              <div
                key={index}
                className="relative w-[180px] h-[320px] shrink-0 mx-2 rounded-[16px] overflow-hidden transition-transform duration-300 ease-in-out hover:scale-105 hover:z-10"
              >
                <Image
                  src={video.src}
                  alt={video.alt}
